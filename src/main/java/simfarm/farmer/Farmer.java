...
public abstract class Farmer {
    ...
    public String toString() {
        return "Business Skill = " + this.getBusinessSkill() + ", Farm Worker Skill = "
                + this.getFarmWorkerSkill() + ", Harvester Skill = " + this.getHarvesterSkill()
                + ", Breeder Skill = " + this.getBreederSkill() + ", Horticulture Skill = "
                + this.getHorticultureSkill() + ", Veterinarian Skill = "
                + this.getVeterinarianSkill();
    }
}
